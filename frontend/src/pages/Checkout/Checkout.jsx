...
//         first_name: "", // Using snake_case consistently
//         last_name: "",
//         email: "",
//         phone: "",
//         address_flat: "",
...
//     // This useEffect creates the Payment Intent when the component loads or the cart changes.
//     useEffect(() => {
...
//         };
//         createPaymentIntent();
//     }, [all_products, cartItems]); // Re-run if cart changes

//     const changeHandler = (e) => {
//         setShippingDetails({ ...shippingDetails, [e.target.name]: e.target.value });
//     };

//     // 2. THIS IS THE FUNCTION TO BE CALLED AFTER A SUCCESSFUL PAYMENT
//     const saveOrderToBackend = async (paymentIntentId) => {
//         const orderCartItems = all_products
//             .filter(product => cartItems[product.id] > 0)
//             .map(product => ({ id: product.id, quantity: cartItems[product.id] }));
...
//             paymentIntentId: paymentIntentId // Pass the payment ID
//         };
...
//                 <CheckoutForm onSuccessfulPayment={saveOrderToBackent} />
//               </Elements>
//             )}
//             <div className="my-3">
//               <p>
